...
function Slackbot(configuration) {
  ...
  slack_botkit.setupWebserver = function(port,cb) {
    ...
    slack_botkit.willStartWebserver(slackbot_kit.webserver);
  ...
  slack_botkit.willStartWebserver = function(webserver) {
      //abstract method for adding/overriding any epxress webserver settings
  }
